...
INTEGRATION_WEBHOOK_SECRET=[REDACTED_SECRET_4d5f471e0fc6]

MATRIX_WEBHOOK_SECRET=[REDACTED_SECRET_43029c315a43]
MATRIX_OUTBOUND_URL=https://<matrix-bridge-host>/api/bridge
MATRIX_OUTBOUND_SECRET=[REDACTED_SECRET_2486d1147d92]

VK_WEBHOOK_SECRET=[REDACTED_SECRET_6c6c1f06060e]
VK_OUTBOUND_URL=https://<vk-bridge-host>/api/bridge
VK_OUTBOUND_SECRET=[REDACTED_SECRET_46f44b2415dd]

MAX_WEBHOOK_SECRET=[REDACTED_SECRET_d4bab26dd624]
MAX_OUTBOUND_URL=https://<max-bridge-host>/api/bridge
MAX_OUTBOUND_SECRET=[REDACTED_SECRET_abb90cad32bb]

...
INTEGRATION_WEBHOOK_SECRET=[REDACTED_SECRET]

MATRIX_WEBHOOK_SECRET=[REDACTED_SECRET]
MATRIX_OUTBOUND_URL=https://<matrix-bridge-host>/api/bridge
MATRIX_OUTBOUND_SECRET=[REDACTED_SECRET]

VK_WEBHOOK_SECRET=[REDACTED_SECRET]
VK_OUTBOUND_URL=https://<vk-bridge-host>/api/bridge
VK_OUTBOUND_SECRET=[REDACTED_SECRET]

MAX_WEBHOOK_SECRET=[REDACTED_SECRET]
MAX_OUTBOUND_URL=https://<max-bridge-host>/api/bridge
MAX_OUTBOUND_SECRET=[REDACTED_SECRET]
